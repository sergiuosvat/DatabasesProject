...
public class OrarAstaziController implements Initializable {
    @FXML
    private Button back;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("CALL programStudent(?,?,?,?,?)");
            ...
            preparedStatement1 = connection.prepareStatement("SELECT * from tabelzicurentastud");
